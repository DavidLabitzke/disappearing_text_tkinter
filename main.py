...
DEATH_BACKGROUND_COLOR = "#000000"
MAIN_SECONDS_REMAINING = 300
DEATH_SECONDS_REMAINING = 6
DISCLAIMER_DEFAULT = "You have 5 minutes to type! Don't fall asleep!"
...
def main_countdown(count):
    """The 5-minute timer for the program"""
...
main_timer_label = Label(text="5:00", font=TIMER_FONT, background=BEGINNING_BACKGROUND_COLOR)
